...
# --- CONSTANTS ---
FLOW_ZONES = ["A1", "A2", "A3", "A4", "B1", "B2", "B3", "BC", "FD", "SPD", "SPC", "C1", "C2", "C3"]
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.create_zone_box(flow_grid, "B3", "#e17055", 0, 6, True)
        ...
        self.create_zone_box(flow_grid, "FD", "#e17055", 1, 3, True)
        self.create_zone_box(flow_grid, "C1", "#6c5ce7", 1, 4, True)
        self.create_zone_box(flow_grid, "C2", "#6c5ce7", 1, 5, True)
        self.create_zone_box(flow_grid, "C3", "#6c5ce7", 1, 6, True)
